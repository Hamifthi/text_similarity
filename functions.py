...
# input_graph_path = os.path.join('E:/Hamed/Projects/Python/Text Similarity/graph/', 'example.pb')
# input_saver_def_path = ''
# input_binary = False
# output_node_names = ''
# restore_op_name = "save/restore_all"
# filename_tensor_name = ''
# output_graph_path = os.path.join('E:/Hamed/Projects/Python/Text Similarity/graph/', 'new_frozen_example.pb')
# clear_devices = False
# checkpoint_path = os.path.join('E:/Hamed/Projects/Python/Text Similarity/graph/', 'checkpoint')
